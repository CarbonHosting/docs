...
```bash
toggled init website
```

This will create a new toggled.json file with the type set to website.
...
```bash
toggled reserve {Your Site Name}
```

Finally, deploy the site with the command below.
